...
class Candidate(models.Model):
    ...
    election_id = models.CharField(verbose_name="ID do candidato na Eleição", max_length=255, null=True, blank=True)
    ...
    region = models.CharField(max_length=255, null=True, blank=True, verbose_name="Região")
    year = models.CharField(max_length=255, null=True, blank=True, verbose_name="Ano da Eleição")
    uf = models.CharField(max_length=255, null=True, blank=True, verbose_name="UF")


    @property
    def url(self):
        url = "https://divulgacandcontas.tse.jus.br/divulga/#/candidato/{}/{}/{}/{}/{}/{}"
        return url.format(self.region, self.uf, self.year, self.site_id, self.year, self.municipio_id)
